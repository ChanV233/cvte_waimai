...
public class IdGenerator {
    ...
    private final long INIT_EPOCH = 1650789964886L;

    // 时间位取&
    private final long TIME_BIT = 0b1111111111111111111111111111111111111111110000000000000000000000L;
    ...
    // workId位需要左移的位数 12
    private final long WORK_ID_SHIFT = SEQUENCE_BITS;
...
//        System.out.println(currentTimeMillis);
     ...
     * @return
     */
    public Date getTimeBySnowFlakeId(long id) {
